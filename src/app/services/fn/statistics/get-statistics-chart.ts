...
export function getStatisticsChart(http: HttpClient, rootUrl: string, params: GetStatisticsChart$Params, context?: HttpContext): Observable<StrictHttpResponse<GetStatisticsChartResponse>> {
