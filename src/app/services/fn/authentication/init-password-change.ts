...
export function initPasswordChange(http: HttpClient, rootUrl: string, params: InitPasswordChange$Params, context?: HttpContext): Observable<StrictHttpResponse<ChangeInitPasswordResponse>> {
